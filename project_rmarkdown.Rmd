...
Author: "Yathor Oo"
---
#Analysis of online ads for Data Science jobs
...
Just like any sane person would do these days, I googled "web scraping indeed" to see if I can scrape its job ads to analyse them. I came across [this awesome blog](https://jessesw.com/Data-Science-Skills/) by Jesse Steinweg-Woods published in March 2015. He looked at the data science tools mentioned in the job ads from indeed for Seattle, Chicago, San Francisco, New York and Nationwide.  
...
2. To examine the ranking of Canadian and American cities based on opportunities for Data Scientists
...
###Source of data
I used [indeed.com](http://www.indeed.com/) and [indeed.ca](http://www.indeed.ca/) to gather job ads. 
...
* `master_39cities` which include percentage of word frequency for all 4 job titles (Data Analysts, Data Scientists, Data Architects, Data Engineers) and
* `master_53cities` which include percentage of word frequency for 3 job titles (Data Analysts, Data Scientists, Data Architects) 
* `num_posting_US` which include the number for job postings for each job title in each of the 53 cities
...
It's really interesting to see that the top 2 most-mentioned tools for data analysts are SQL & Excel whereas those for data scientists are R & Python. 
The percentage of job ads that asked for SQL was pretty consistent across all four job titles. Same goes for Hadoop, except in job ads for Data analysts where it was asked only 4.9% of the time. 
