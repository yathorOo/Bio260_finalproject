...
```{r}
avg_appearance_39 %>% 
  select(Term, avg_DAnalyst) %>% 
  arrange(desc(avg_DAnalyst))
```
...
```{r}
avg_appearance_39 %>% 
  select(Term, avg_DScientist) %>% 
  arrange(desc(avg_DScientist))
```
...
```{r}
avg_appearance_39 %>% 
  select(Term, avg_DArchitect) %>% 
  arrange(desc(avg_DArchitect))
```
...
```{r}
avg_appearance_39 %>% 
  select(Term, avg_DEngineer) %>% 
  arrange(desc(avg_DEngineer))
```
...
###Stackoverflow data: (362 job ads)
